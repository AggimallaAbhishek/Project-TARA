...
class TestThreatValidation:
    ...
    def test_threat_with_valid_evidence(self):
        ...
        threat = {
            ...
            "likelihood": 4,
            "impact": 5,
            "mitigation": "1. Enable HTTPS. 2. Enforce TLS 1.2+.",
            "assumptions": [],
            "owasp_tags": [],
            "cwe_tags": [],
        }
    ...
    def test_threat_rejected_with_single_evidence(self):
        ...
        threat = {
            ...
            "likelihood": 4,
            "impact": 5,
            "mitigation": "Enable DB authentication",
            "assumptions": [],
            "owasp_tags": [],
            "cwe_tags": [],
        }
    ...
    def test_threat_accepted_at_minimum_confidence(self):
        ...
        threat = {
            ...
            "likelihood": 3,
            "impact": 3,
            "mitigation": "1. Add rate limiting. 2. Monitor queue depth.",
