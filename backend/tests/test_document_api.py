...
class DocumentApiTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        async def fake_analyze_system(system_description: str, **kwargs):
                    ...
                    [
                        {
                            ...
                            "likelihood": 3,
                            "impact": 4,
                            "mitigation": "Rotate tokens.", "evidence": ["Point 1", "Point 2"], "confidence": 0.9
                        },
                        {
                            "name": "SQL Injection",
                            ...
                            "likelihood": 4,
                            "impact": 5,
                            "mitigation": "Use parameterized queries.", "evidence": ["Point 1", "Point 2"], "confidence": 0.9
                        },
                    ],
                    0.02,
                )
                ...
                [
                    {
                        ...
                        "likelihood": 2,
                        "impact": 4,
                        "mitigation": "Rotate tokens and bind sessions.", "evidence": ["Point 1", "Point 2"], "confidence": 0.9
                    },
                    {
                        ...
                        "likelihood": 3,
                        "impact": 4,
                        "mitigation": "Enforce RBAC checks.", "evidence": ["Point 1", "Point 2"], "confidence": 0.9
                    },
                ],
                0.02,
            )
