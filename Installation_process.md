...
|---|----------|----------------|--------------|---------------|
| 1 | **Git** | 2.30+ | Clone the project source code | https://git-scm.com/downloads |
| 2 | **Docker Desktop** | 4.0+ | Run database, cache, and app containers | https://www.docker.com/products/docker-desktop |
| 3 | **Ollama** | Latest | Run AI models locally on your machine | https://ollama.ai/download |
...
✅ All four commands should succeed before proceeding.
...
cd ~/Documents    # or any folder of your choice
...
```bash
# From the Project-TARA root directory:
./scripts/dev-up.sh
```
